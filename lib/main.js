...
const {returnTitleOnly,getIdOfValue} = require('./helpers.js');
        ...
        .then(async (response)=>{
            ...
            switch (command) {
                ...
                case 'view all roles':
                    ...
                    break;
                case 'add role':
                    const bodyRequest = await roleAdd();
...
const roleAdd = async ()=>{
    ...
    await inquirer.prompt(
        [
            ...
            new Question('department_id','list', 'What is the Department of this Role?' )
